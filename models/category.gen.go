...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.CategoryID = field.NewInt32(tableName, "category_id")
	_category.CategoryName = field.NewString(tableName, "category_name")
	_category.CategoryDescription = field.NewString(tableName, "category_description")
...
func (c *category) updateTableName(table string) *category {
	...
	c.CategoryDescription = field.NewString(table, "category_description")
...
func (c *category) fillFieldMap() {
	...
	c.fieldMap["category_description"] = c.CategoryDescription
