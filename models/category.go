...
type Category struct {
	...
	CategoryDescription null.String `boil:"category_description" json:"category_description,omitempty" toml:"category_description" yaml:"category_description,omitempty"`
...
var CategoryWhere = struct {
	...
	CategoryDescription whereHelpernull_String
	CreatedAt           whereHelpertime_Time
}{
	CategoryID:          whereHelperint{field: "`category`.`category_id`"},
	CategoryName:        whereHelpernull_String{field: "`category`.`category_name`"},
	CategoryDescription: whereHelpernull_String{field: "`category`.`category_description`"},
...
var (
	categoryAllColumns            = []string{"category_id", "category_name", "category_description", "created_at"}
	categoryColumnsWithoutDefault = []string{"category_name", "category_description"}
	categoryColumnsWithDefault    = []string{"category_id", "created_at"}
...
func (o *Category) Products(mods ...qm.QueryMod) productQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`product`.`category_id`=?", o.CategoryID),
	)
...
func (o *Category) SetProducts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Product) error {
	query := "update `product` set `category_id` = null where `category_id` = ?"
